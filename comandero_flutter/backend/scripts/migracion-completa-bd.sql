...
-- Basado en: BD - Script ACTUALIZADO (FINAL).sql
-- ============================================
-- Este script crea todas las tablas necesarias para el proyecto
-- Preserva los datos existentes del usuario "admin"
-- ============================================
...
-- ============================================
-- ETAPA 1: Preservar datos existentes
-- ============================================
-- Crear tabla temporal para guardar usuarios existentes
CREATE TEMPORARY TABLE IF NOT EXISTS temp_usuarios_backup AS
SELECT * FROM usuario WHERE username = 'admin';

-- ============================================
-- ETAPA 2: Crear tablas de usuarios/roles/permisos
-- ============================================
-- La tabla usuario ya existe, solo verificar estructura
-- Si falta alguna columna, se agregará después
