...
const gestionRoles = requireRoles('administrador', 'capitan', 'mesero', 'cajero', 'gerente');
const cambioEstadoRoles = requireRoles('administrador', 'capitan', 'mesero', 'cajero', 'gerente');
