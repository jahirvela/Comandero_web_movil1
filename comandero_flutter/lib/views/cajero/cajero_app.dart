...
class CajeroApp extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Notas del mesero
              if (bill.waiterNotes != null && bill.waiterNotes!.isNotEmpty) ...[
                const SizedBox(height: 12),
                Container(
              ...
              // Información del cliente (para llevar)
              if (bill.isTakeaway && bill.customerPhone != null) ...[
                const SizedBox(height: 12),
                Row(
                  children: [
                    Text(
              ...
              // Botones de acción
              _buildBillActionButtons(context, bill, controller, isTablet),
            ],
          ),
        ),
      ),
  ...
  Widget _buildBillActionButtons(
    BuildContext context,
    BillModel bill,
    CajeroController controller,
    bool isTablet,
    ...
    return Wrap(
      ...
      children: [
        ...
        if (!bill.isPrinted)
          OutlinedButton.icon(
            onPressed: () =>
                _showPrintTicketDialog(context, bill, controller, isTablet),
        ...
        ElevatedButton.icon(
          onPressed: () =>
              CashPaymentModal.show(context, bill, controller, isTablet),
        ...
        ElevatedButton.icon(
          onPressed: () =>
              CardPaymentModal.show(context, bill, controller, isTablet),
